        ...
        <div class="cart-body">
            ...
            <div class="already-registered clearfix">
                <div class="pull-right float-right">
                    <button type="button"
                            class="btn btn-info{if $loggedin || !$loggedin && $custtype eq "existing"} w-hidden{/if}"
                            id="btnAlreadyRegistered">
                        {$LANG.orderForm.alreadyRegistered}
                    </button>
                    <button type="button"
                            class="btn btn-warning{if $loggedin || $custtype neq "existing"} w-hidden{/if}"
                            id="btnNewUserSignup">
                                ...
                                <div class="account{if $selectedAccountId == $account->id} active{/if}">
                                    <label class="radio-inline" for="account{$account->id}">
                                        <input id="account{$account->id}"
                                               ...
                                               type="radio" name="account_id"
                                               value="{$account->id}"{if $account->isClosed || $account->noPermission || $inExpressCheckout} disabled="disabled"{/if}{if $selectedAccountId == $account->id} checked="checked"{/if}>
                                        <span class="address">
                                            <strong>
...
{elseif $account->currencyCode}
                        ...
                        <div class="col-sm-12">
                            <div class="account border-bottom{if !$selectedAccountId || !is_numeric($selectedAccountId)} active{/if}">
                                <label class="radio-inline">
                                    <input class="account-select" type="radio" name="account_id"
                                           value="new"{if !$selectedAccountId || !is_numeric($selectedAccountId)} checked="checked"{/if}{if $inExpressCheckout} disabled="disabled" class="disabled"{/if}>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="address1" id="inputAddress1" class="field form-control"
                                       placeholder="{$LANG.orderForm.streetAddress}" value="{$clientsdetails.address1}">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group prepend-icon">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="password" name="password" id="inputNewPassword1"
                                           ...
                                           class="field form-control"
                                           placeholder="{$LANG.clientareapassword}"{if $remote_auth_prelinked} value="{$password}"{/if}>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="password" name="password2" id="inputNewPassword2"
                                           class="field form-control"
                                           placeholder="{$LANG.clientareaconfirmpassword}"{if $remote_auth_prelinked} value="{$password}"{/if}>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="password-strength-meter">
                                    ...
                                    <p class="text-center small text-muted"
                                       id="passwordStrengthTextLabel">{$LANG.pwstrength}: {$LANG.pwstrengthenter}</p>
                                </div>
                            </div>
                        </div>
                ...
                <div id="applyCreditContainer" class="apply-credit-container{if !$canUseCreditOnCheckout} w-hidden{/if}"
                    ...
                    <label class="radio">
                        <input id="useCreditOnCheckout" type="radio" name="applycredit"
                    ...
                    <label class="radio">
                        <input id="skipCreditOnCheckout" type="radio" name="applycredit"
                ...
                {if !$inExpressCheckout}
                    ...
                    <div class="clearfix"></div>
                    <div class="cc-input-container{if $selectedgatewaytype neq "CC"} w-hidden{/if}"
                            ...
                            <li>
                                <label class="radio-inline">
                                    <input type="radio" name="ccinfo" value="new"
                                           id="new" {if !$client || $client->payMethods->count() === 0} checked="checked"{/if} />
                                    &nbsp;
                        ...
                        <div class="row" id="newCardInfo">
                            <div id="cardNumberContainer" class="col-sm-6 new-card-container">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="tel" name="ccnumber" id="inputCardNumber"
                                           ...
                                           placeholder="{$LANG.orderForm.cardNumber}" autocomplete="cc-number"
                            ...
                            <div class="col-sm-3 new-card-container">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="tel" name="ccexpirydate" id="inputCardExpiry"
                                           class="field form-control"
                            ...
                            {if $showccissuestart}
                                <div class="col-sm-3 col-sm-offset-6 new-card-container offset-sm-6">
                                    <div class="form-group prepend-icon">
                                        ...
                                        <input type="tel" name="ccstartdate" id="inputCardStart"
                                               class="field form-control"
                                ...
                                <div class="col-sm-3 new-card-container">
                                    <div class="form-group prepend-icon">
                                        ...
                                        <input type="tel" name="ccissuenum" id="inputCardIssue"
                                               class="field form-control" placeholder="{$LANG.creditcardcardissuenum}">
                                    </div>
                                </div>
                            {/if}
                        </div>
                            ...
                            <div class="row form-group new-card-container">
                                <div id="inputDescriptionContainer" class="col-md-6">
                                    <div class="prepend-icon">
                                        ...
                                        <input type="text" class="field form-control" id="inputDescription"
                                               name="ccdescription" autocomplete="off" value=""
...
<script type="text/javascript">
    jQuery("#btnCompleteOrder").on("click", function () {
        if ($('#creditCardInputFields').css('display') == 'none') {
            $("#inputCardCVV").prop('required', false);
            $("#inputCardCVV2").prop('required', false);
        }

        if (jQuery("#inputCardCVV").val() !== '' || jQuery("#inputCardCVV2").val() !== '') {
            jQuery("#btnCompleteOrder").addClass("disabled");
            jQuery(".fa-arrow-circle-right").addClass("fas fa-spinner fa-spin");
        }
    });
    jQuery("#paymentGatewaysContainer").on("change", function () {
        if($('#existingCardsContainer').css('display') === 'none') {
            return;
        }
        setInterval(function () {
            if ($('#existingCardInfo').css('display') == 'none') {
                $("#existingCardInfo").css("display", "flex");
            }
            if($('#iCheck-new').hasClass('checked')) {
                $("#existingCardInfo").css("display", "none");
            }
        }, 100);
    });
</script>
