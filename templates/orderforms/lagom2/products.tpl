            ...
            <div class="section products" id="products">
                <div class="row row-eq-height row-eq-height-sm">
                    ...
                    {foreach from=$products item=product}
                        ...
                        <div class="col{if $RSThemes['pages'][$templatefile]['config']['horizontalPackage'] == 1} col-12{/if}">
                                                ...
                                                {else}
                                                    ...
                                                    {if isset($RSThemes['addonSettings']['price_calculation']) && $RSThemes['addonSettings']['price_calculation'] == "lowest"}
                                                        {if $display_billing_monthly_price}
                                                            {include file="$template/includes/common/price.tpl" 
                                                                price=$productsPricing[$product.pid]->price
                                                                priceCycle="monthly"
                                                        ...
                                                        {else}       
                                                            ...
                                                            {include file="$template/includes/common/price.tpl" 
                                                                price={formatCurrency($productsPricing[$product.pid]->real_price)}
