...
{else} 
    ...
    {else}
            ...
            <div class="row domain-suggestions">
                {foreach $searchResults.suggestions as $num => $result}
                    <div class="col-sm-6 margin-bottom-5">
                        ...
                        <label>
                            <input type="checkbox" name="domains[]" value="{$result.domainName}" id="domainSuggestion{$num}" class="suggested-domains icheck-control" />
                            {$result.domainName}
                        </label>
        ...
        {/if}
        {if $continueok}
            <div class="alert alert-lagom alert-info info-text-sm">
