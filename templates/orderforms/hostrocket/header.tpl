...
<section id="header">
    <div class="container">
        ...
        {else}
            <a href="{$WEB_ROOT}/index.php" class="logo logo-text"><img class="logo" src="{{assetPath file='logo.png'}|replace:'/png/':'/images/'}" width="143" height="18" alt="{$companyname}"></a>
        {/if}
        ...
        <div class="row">
            <div class="col-xs-12 text-center rocket-animation-holder">
                <div class="rocket-animation">
                    <div class="rocket">
                        <img src="{{assetPath file='rocket.png'}|replace:'/png/':'/images/'}" width="136" height="190">
                        <span class="rocket-line rline1"></span>
                        <span class="rocket-line rline2"></span>
                        <span class="rocket-line rline3"></span>
                    </div>
                    <div class="cloud cloud1"><img src="{{assetPath file='cloud.png'}|replace:'/png/':'/images/'}" width="60" height="35"></div>
                    <div class="cloud cloud2"><img src="{{assetPath file='cloud.png'}|replace:'/png/':'/images/'}" width="60" height="35"></div>
                    <div class="cloud cloud3"><img src="{{assetPath file='cloud.png'}|replace:'/png/':'/images/'}" width="60" height="35"></div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-5 btn-go-holder">
                                    ...
                                    {if $registerdomainenabled}
                                        <li><input type="submit" class="btn-go btn search{$captcha->getButtonClass($captchaForm)}" value="{$LANG.search}" id="btnDomainSearch" /></li>
                                    {/if}
                                    {if $transferdomainenabled}
                                        <li><input type="submit" id="btnTransfer" class="btn-go d-color btn transfer{$captcha->getButtonClass($captchaForm)}" value="{$LANG.domainstransfer}" /></li>
                                    {/if}
                                    </ul>
                                </div>
                            </div>
    ...
    <div class="container">
        ...
        <div class="row feature-row rtl-row">
            <div class="col-sm-12 col-md-5 text-center">
                <img class="feature-image" src="{{assetPath file='feature1.png'}|replace:'/png/':'/images/'}">
            </div>
        ...
        <div class="row feature-row">
            <div class="col-sm-12 col-md-5 text-center">
                <img class="feature-image" src="{{assetPath file='feature2.png'}|replace:'/png/':'/images/'}">
            </div>
            <div class="col-sm-12 col-md-7">
                    ...
                    <div class="testimonial-slide">
                        <div class="slide-content">
                            <div class="col-sm-12 col-md-3">
                                <img src="{{assetPath file='sample.jpg'}|replace:'/jpg/':'/images/'}" alt="">
                            </div>
