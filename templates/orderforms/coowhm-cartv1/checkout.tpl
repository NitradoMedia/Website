...
<div id="order-standard_cart">
	...
	<div class="promo-code-cart-container row">
	<div class="col-md-12">
            {if $promotioncode}
    ...
    <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" name="orderfrm" id="frmCheckout" class="row">
            <div class="col-md-8">
                ...
                <div class="already-registered clearfix new-coowhm">
				<div class="login-claaa-box {if $loggedin} w-hidden{/if}">
                    <div class="activite-logreg-form" id="btnAlreadyRegistered">
				...
				<div class="regi-claaa-box {if $loggedin}rah-login{/if}" id="justfornothing">
                <div class="activite-logreg-form" id="btnNewUserSignup">
                        ...
                        <div class="text-center">
                            {foreach $gateways as $gateway}
                                <label class="radio-inline">
									...
									<span data-toggle="tooltip" data-placement="left" title="{$LANG.creditcard}" class="gateway-icon-cc {$gateway.sysname}">
                        ...
                        <div class="order-summary" id="orderSummary">
                            ...
                            <div class="summary-container">
                                ...
                                <div class="text-right">
                                  <button type="submit" id="btnCompleteOrder" class="btn btn-primary btn-checkout disable-on-click spinner-on-click{if $captcha}{$captcha->getButtonClass($captchaForm)}{/if}" {if $cartitems==0}disabled="disabled"{/if}>
                                  {if $inExpressCheckout}{$LANG.confirmAndPay}{else}{$LANG.completeorder}{/if}
                                  &nbsp;<i class="fas fa-arrow-right"></i>
                                  </button>
					              <br />
                                  <a href="{$WEB_ROOT}/cart.php" class="btn btn-link btn-continue-shopping" id="continueShopping">{$LANG.orderForm.continueShopping}</a>
                                </div>
                            </div>
                        </div>
