                        ...
                        <li id="product{$product@iteration}">
                            <div class="plan-box {if $product.isFeatured} best-seller{/if}">
                                ...
                                <div class="plan-box-button">
                                    ...
                                    {else}
                                        <a class="color-bg{$counter}" href="{$WEB_ROOT}/cart.php?a=add&amp;{if $product.bid}bid={$product.bid}{else}pid={$product.pid}{/if}" id="product{$product@iteration}-order-button">{$LANG.ordernowbutton}</a>
                                    {/if}
                                </div>
                            </div>
                        </li>
