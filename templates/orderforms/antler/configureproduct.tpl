        ...
        <div class="col-md-12">
            ...
            <div class="header-lined">
                <div class="text-center">
                    <h1 class="section-heading mergecolor border-0">{$LANG.orderconfigure}</h1>
                    <p class="section-subheading mergecolor">{$LANG.orderForm.configureDesiredOptions}</p>
                </div>
                ...
                <form id="frmConfigureProduct">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="product-info bg-seccolorstyle bg-pratalight border-0 noshado">
                                <p class="product-title mergecolor ">{$productinfo.name}</p>
                                <p class="mergecolor">{$productinfo.description}</p>
                            </div>
                            <div class="alert alert-danger w-hidden mergecolor" role="alert" id="containerProductValidationErrors">
                                <p class="mergecolor">{$LANG.orderForm.correctErrors}:</p>
                            <ul id="containerProductValidationErrorsList"></ul>
                        </div>

                        {if $pricing.type eq "recurring"}
                        <div class="field-container bg-seccolorstyle bg-pratalight border-0 noshado">
                            <div class="form-group">
                                <p class="product-title mergecolor f-18 mb-4" for="inputBillingcycle">{$LANG.cartchoosecycle}</p>
                        ...
                        <div class="sub-heading">
                            <span class="mergecolor f-18 mb-4">{$LANG.metrics.title}</span>
                        </div>
                        ...
                        {if $productinfo.type eq "server"}
                            <div class="sub-heading">
                                <span class="mergecolor f-18 mb-4">{$LANG.cartconfigserver}</span>
                            </div>
                        ...
                        <div class="sub-heading">
                            <span class="mergecolor f-18 mb-4">{$LANG.orderconfigpackage}</span>
                        </div>
                        ...
                        <div class="sub-heading pb-1">
                            <span class="primary-bg-color mergecolor f-18 mb-4">{$LANG.orderadditionalrequiredinfo} <i><small>{lang key='orderForm.requiredField'}</small></i></span>
                        </div>
                        <div class="field-container">
                        ...
                        <div id="productAddonsContainer">
                            <div class="sub-heading">
                                <span class="mergecolor f-18 mb-4">{$LANG.cartavailableaddons}</span>
                            </div>
                        ...
                        <div id="orderSummary">
                            <div class="order-summary">
                                ...
                                <div class="text-right">
                                    <button type="submit" id="btnCompleteProductConfig" class="btn btn-default-yellow-fill btn-lg">
                                    {$LANG.continue}
