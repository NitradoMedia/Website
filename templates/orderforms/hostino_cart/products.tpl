                            ...
                            <div class="pricing-box pr-color{$counter}{if $product.isFeatured} recommended{/if}">
                                ...
                                <div class="pricing-box-body">
                                        ...
                                        <div class="price">
                                            ...
                                            {else}
                                                {if $product.pricing.hasconfigoptions}
                                                    {$LANG.from}
                                                {/if}
                                                    <span class="amount">{$product.pricing.minprice.cycleText}
                                                </span>
                                    ...
                                    <div class="pricing-button">
                                        ...
                                        {else}
                                            <a class="pricing-button" href="{$WEB_ROOT}/cart.php?a=add&amp;{if $product.bid}bid={$product.bid}{else}pid={$product.pid}{/if}" id="product{$product@iteration}-order-button">
                                                {$LANG.ordernowbutton}
                                            </a>
                                        {/if}
                                    </div>
