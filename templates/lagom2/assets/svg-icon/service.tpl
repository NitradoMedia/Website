...
<polygon class="svg-icon-prime svg-icon-stroke" points="19,25 19,39.3 32,46.8 45,39.3 45,25"/>
<polygon class="svg-icon-prime-l svg-icon-stroke" points="32,32.2 19,24.7 32,17.2 45,24.7"/>
</svg>