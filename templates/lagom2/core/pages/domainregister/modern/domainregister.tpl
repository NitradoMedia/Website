        ...
        <form method="post" action="{$WEB_ROOT}/cart.php" id="frmDomainChecker">
            ...
            <div class="domain-search-input search-group search-group-combined">
                <div class="search-field search-field-lg">
                    ...
                    <input class="form-control form-control-lg"  type="text" name="domain" placeholder="{$LANG.findyourdomain}" value="{$lookupTerm}" id="inputDomain" data-toggle="tooltip" data-placement="top" data-trigger="manual" title="{lang key='orderForm.domainOrKeyword'}" />
                </div>
                <div class="search-group-btn">
                    <button class="btn btn-lg btn-primary domain-check-availability {if $captcha}{$captcha->getButtonClass($captchaForm)}{/if}" type="submit" id="btnCheckAvailability">
