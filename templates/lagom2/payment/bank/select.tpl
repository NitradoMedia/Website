    ...
    {if count($existingAccounts) > 0}
        <div class="panel-nav">
            <ul class="nav nav-tabs">
                <li {if $existingAccount && $payMethodId neq "new"}class="active"{/if}>
                    <a href="#existingBankInfo" data-simple-radio-tab data-toggle="tab" aria-expanded="true">                                    
                        {$LANG.paymentMethodsManage.bankAccount}
                    </a>
                </li>
                <li {if $payMethodId eq "new" || !$existingAccount}class="active"{/if}>
                    <a href="#newBankInfoTab" data-simple-radio-tab data-toggle="tab" aria-expanded="false">
                        <div class="hidden">
