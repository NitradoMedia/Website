                    ...
                    <div class="panel panel-summary panel-summary-{$sidebarBoxStyle} view-invoice panel-view-invoice">
                        ...
                        <div class="panel-footer">
                            ...
                            {if $status eq "Unpaid" || $status eq "Draft"}
                                ...
                                <div class="payment-form payment-btn-container  {if $bankTransfer}bank-transfer{/if}" data-btntext="{$LANG.makepayment}" data-btnsubscribetext="{$rslang->trans('billing.subscribe')}">
