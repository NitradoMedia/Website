...
{else}
    ...
    {if $templatefile == "knowledgebasearticle" || $templatefile == "viewannouncement" || $templatefile == "knowledgebasecat"}
        ...
        {if $templatefile == "knowledgebasearticle"}
            <link rel="alternate" hreflang="{$activeLocale.locale}" href="{$systemsslurl}knowledgebase/{$kbarticle.id}/{$kbarticle.urlfriendlytitle}.html"/>
        {elseif $templatefile == "viewannouncement"}
            <link rel="alternate" hreflang="{$activeLocale.locale}" href="{$systemsslurl}announcements/{$id}/{$urlfriendlytitle}.html"/>
        {/if}
    {elseif $templatefile == "products"}
        ...
        {foreach from=$productgroups item=foo}
            ...
            {/if}
        {/foreach}
        <link rel="alternate" hreflang="{$activeLocale.locale}" href="{$systemsslurl}store/{$productSlug}"/>
    ...
    {elseif $siteSeoDesc}
        ...
        {/if}
        <link rel="alternate" hreflang="{$activeLocale.locale}" href="{$systemsslurl}store/{$routePathSlug}"/>
    {/if}
