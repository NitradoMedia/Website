...
{else}
    ...
    {if ($language == 'arabic' || $language == 'hebrew' || $language == 'farsi') && file_exists("templates/{$template}/assets/css/theme-rtl.css")}
        ...
        {if ($isSite || isset($custompage) || (isset($activeDisplay) && $activeDisplay == 'CMS' && $pageType == "website")) && file_exists("templates/{$template}/assets/css/site-rtl.css")}
    ...
    {else}
        ...
        {if $isSite || isset($custompage) || (isset($activeDisplay) && $activeDisplay == 'CMS' && $pageType == "website")}
