                ...
                <div class="section-graphic">
                    <div class="browser browser-sm">
                        ...
                        <div class="browser-body">
                            {include file="$template/includes/common/svg-icon.tpl" icon="incoming-filter-3"}
                        </div>
                    </div>
                </div>
                <div class="section-content">
            ...
            <div class="section-sides">
                <div class="section-graphic">
                    <div class="browser browser-sm">
                        ...
                        <div class="browser-body">
                            {include file="$template/includes/common/svg-icon.tpl" icon="outgoing-filter-1"}
                        </div>
                    </div>
                </div>
                <div class="section-content">
            ...
            <div class="section-sides">
                <div class="section-graphic">
                    <div class="browser browser-sm">
                        ...
                        <div class="browser-body">
                            {include file="$template/includes/common/svg-icon.tpl" icon="archiving-1"}
                        </div>
                    </div>
                </div>
                <div class="section-content">
