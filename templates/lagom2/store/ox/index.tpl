                ...
                <div class="section-graphic">
                    <div class="browser browser-sm">
                        ...
                        <div class="browser-body">
                            {include file="$template/includes/common/svg-icon.tpl" icon="incoming-filter-1"}  
                        </div>
                    </div> 
                </div>
            ...
            <div class="section-sides">
                <div class="section-graphic order-last">
                    <div class="browser browser-sm">
                        ...
                        <div class="browser-body">
                            {include file="$template/includes/common/svg-icon.tpl" icon="outgoing-filter-2"}
                        </div>
                    </div>
                </div> 
            ...
            <div class="section-sides">
                <div class="section-graphic">
                    <div class="browser browser-sm">
                        ...
                        <div class="browser-body">
                            {include file="$template/includes/common/svg-icon.tpl" icon="why-you-need-a-professional-incoming-filter"}
                        </div> 
                    </div> 
                </div>
                <div class="section-content">
