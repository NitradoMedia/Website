...
{if file_exists("templates/$template/store/login/overwrites/sitelock.tpl")}
    {include file="{$template}/store/login/overwrites/sitelock.tpl"}  
{else}
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <h5>{lang key="store.sitelock.title"}</h5>
                    ...
                    <form action="{routePath('upgrade')}" method="post">
                        ...
                        <button type="button" class="btn btn-lg btn-default btn-service-sso">
