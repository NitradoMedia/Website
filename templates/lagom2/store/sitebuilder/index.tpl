                    ...
                    <div class="section-content">
                        <div class="row row-eq-height row-eq-height-xs features">
                            <div class="col-lg-4 col-sm-6">
                                <div class="feature feature-xs-left">
                                    <div class="feature-icon">
                                        {include file="$template/includes/common/svg-icon.tpl" icon="icon-automatic-daily-backu"}
                                    </div>
                                    <div class="feature-content">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="feature feature-xs-left">
                                    <div class="feature-icon">
                                        {include file="$template/includes/common/svg-icon.tpl" icon="shared-hosting.tpl"}
                                    </div>
                                    <div class="feature-content">
